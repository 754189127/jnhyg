Ext.application({
  ...
  launch: function () {
    ...
    Ext.create('Ext.data.Store', {
      storeId: 'product',
      fields: ["key", 'addDate', "averageCost", 'bagShape', 'foreignCurrency', 'id', 'isBelowInventory', 'name', 'number', 'price', 'productCode', "purchasePrice", "receiptId", "safetyStock", "specification", "status", "weight", "cardinalNumber", "content", "companyCode", "address", "companyId","tzqProgressiveCount","tzhProgressiveCount","tzqShipmentCount","tzhShipmentCount"],
      layout: "fit",
      autoLoad: true,
      proxy: {
        type: 'ajax',
          ...
          items: [
            ...
            },
            {
              ...
              columns: [
                ...
                {
                  text: '调整前累进量',
                  dataIndex: 'tzqProgressiveCount',
                  flex: 2
                },
                {
                  text: '调整后累进量',
                  dataIndex: 'tzhProgressiveCount',
                  flex: 2
                },
                {
                  text: '调整前出货数',
                  dataIndex: 'tzqShipmentCount',
                  flex: 2
                },
                {
                  text: '调整后出货数',
                  dataIndex: 'tzhShipmentCount',
                  flex: 2
                },
                {
                  text: '库存数',
